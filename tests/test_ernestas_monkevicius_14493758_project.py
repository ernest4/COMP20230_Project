...
class Test(unittest.TestCase):
    ...
    def test_itineraryOptimizer(self):
        ...
        self.assertTrue(io.getOptimizedItinerary(1) == [['LUP','EKI','YPO','MRV','AGM','A321','->','LUP', 'AGM', 'MRV', 'YPO', 'EKI', 'LUP', 15166.05]])
        self.assertTrue(io.getOptimizedItinerary(1) == [['MAM','BXR','ERS','GDN','NBX','747','->','MAM', 'NBX', 'BXR', 'GDN', 'ERS', 'MAM', 2508.77]])
        self.assertTrue(io.getOptimizedItinerary(1) == [['OLA','OLT','ELU','EGR','MNZ','767','->','OLA', 'MNZ', 'OLT', 'ELU', 'EGR', 'OLA', 10087.17]])
